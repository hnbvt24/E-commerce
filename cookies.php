...
<!-- Main Content of the page -->
                ...
                <div class="bWhite row">
                    <div class="store col-sm-offset-1 col-sm-11">
                        ...
                        <div class="col-sm-offset-3 col-sm-2">
                            <select id="productselect" class="form-control" name="category" onchange="selectedvalue(this.value)">
                        ...
                        <div class="col-sm-2">
                          <?
                             $sql4 = "SELECT * FROM items WHERE category='cookies'";
        ...
        <script>
          ...
          categorylist.options[1].selected = true;
